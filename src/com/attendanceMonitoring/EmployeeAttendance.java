		...
		while(true) {
			...
			switch(option) {
				case 1: binaryTree = new EmpBT();
						root = binaryTree.parseDataAndCreateBST("C:\\Users\\I524718\\Desktop\\New folder\\AttendanceMonitoringSystem1\\src\\com\\attendanceMonitoring\\input.txt");
						break;
				...
				case 5: int max = binaryTree.frequentVisitor(root);
						...
						binaryTree.printData();
						break;
				case 6: System.out.println("Enter the starting employee id and ending employee id with a space in between:");
						int LowEmpId = scan.nextInt();
						int HighEmpId = scan.nextInt();
						binaryTree.printRangePresent(root, LowEmpId, HighEmpId);
						binaryTree.printData();
						break;		
			}
